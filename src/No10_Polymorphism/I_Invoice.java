...
public class I_Invoice implements I_Payable
{
   private String partNumber; 		// 貨品編號
   private String partDescription;	// 貨品描述
   private int quantity;			// 訂貨量
   private double pricePerItem;		// 單價

   // four-argument constructor
   public I_Invoice( String part, String description, int count, 
      double price )
   {
      partNumber = part;
